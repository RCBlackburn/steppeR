...
library(rsconnect)
library(rgee)
reticulate::use_condaenv("C:/Users/Ryan/AppData/Local/r-miniconda/envs/rgee")

# 1. Create the credentials file
ee_Initialize()

# 2. Copy credentials file to the project folder
file_credentials <- sprintf("%s/earthengine/credentials", dirname(rgee::ee_get_earthengine_path()))
